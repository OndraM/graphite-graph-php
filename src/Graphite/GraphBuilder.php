 ...
 * @method $this graphType(string $value)
 * @method $this jsonp(string $value)
 * @method $this local(string $value)
 * @method $this noCache(bool $value)
 * @method $this until(string $value)
 * all graph types:
 * @method $this bgcolor(string $value)
 * @method $this colorList(string $value)
 * @method $this fgcolor(string $value)
 * @method $this fontBold(bool $value)
 * @method $this fontItalic(bool $value)
 * @method $this fontName(string $value)
 ...
 * line graph:
 * @method $this areaAlpha(float $value)
 * @method $this areaMode(string $value)
 * @method $this drawNullAsZero(bool $value)
 * @method $this graphOnly(bool $value)
 * @method $this hideAxes(bool $value)
 * @method $this hideGrid(bool $value)
 * @method $this hideLegend(bool $value)
 * @method $this hideYAxis(bool $value)
 * @method $this leftColor(string $value)
 * @method $this leftDashed(bool $value)
 * @method $this leftWidth(float $value)
 * @method $this lineMode(string $value)
 * @method $this lineWidth(float $value)
 * @method $this logBase(float $value)
 * @method $this majorGridLineColor(string $value)
 * @method $this minorGridLineColor(string $value)
 * @method $this minorY(float $value)
 * @method $this minXStep(float $value)
 * @method $this rightColor(string $value)
 * @method $this rightDashed(bool $value)
 * @method $this rightWidth(float $value)
 * @method $this thickness(float $value)
 * @method $this title(string $value)
 * @method $this tz(string $value)
 * @method $this vtitle(string $value)
 * @method $this xFormat(string $value)
 * @method $this yLimit(float $value)
 * @method $this yLimitLeft(float $value)
 * @method $this yLimitRight(float $value)
 * @method $this yMax(float $value)
 * @method $this yMaxLeft(float $value)
 * @method $this yMaxRight(float $value)
 * @method $this yMin(float $value)
 * @method $this yMinLeft(float $value)
 * @method $this yMinRight(float $value)
 * @method $this yStep(float $value)
 * @method $this yStepLeft(float $value)
 * @method $this yStepRight(float $value)
 * @method $this yUnitSystem(string $value)
 * pie graph:
 * @method $this pieLabels(string $value)
 * @method $this pieMode(string $value)
 * @method $this valueLabels(string $value)
 * @method $this valueLabelsMin(float $value)
 * aliases:
 * @method $this area(string $value)
 * @method $this axes(bool $value)
 * @method $this grid(bool $value)
 * @method $this legend(bool $value)
